...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("distance to hub", Math.min(turretPose.getTranslation().minus(FieldConstants.Hub.RED_CENTER_POINT.getTranslation()).getNorm(), turretPose.getTranslation().minus(FieldConstants.Hub.CENTER_POINT.getTranslation()).getNorm()));
